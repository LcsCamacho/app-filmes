...
export default function CardFilme({ filme }: { filme: Filme }) {
  return (
    <Card
      isFooterBlurred
      radius="lg"
      className="border-none max-w-[350px] relative w-[350px] h-[550px] hover:scale-105 transition-all cursor-pointer duration-250"
      isHoverable
    >
      <Image
